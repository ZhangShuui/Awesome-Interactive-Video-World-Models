...
* Ring Forcing: Towards Precise Long-Term Memory for Autoregressive Video Diffusion. **`ECCV 2026`** [[Paper](https://arxiv.org/abs/2608.26794)] · 🧠`memory`
...
* **`BeyondMasks`**, Evaluating Causal and Physical Consistency in Video Object Removal. **`ECCV 2026`** [[Paper](https://arxiv.org/abs/2608.20107)] · 🧠`memory` 📊`benchmarks`
...
* **`LinCa`**, Accelerating Diffusion Models via Learnable Decomposed Feature Caching. **`ECCV 2026`** [[Paper](https://arxiv.org/abs/2608.17973)] · ⚡`realtime`
...
* Towards Memory-Efficient Autoregressive Video Generation via Instance-Specific Parametric Absorption. **`ECCV 2026`** [[Paper](https://arxiv.org/abs/2607.00712)] · ⚡`realtime`
...
* **`MemLearner`**, Learning to Query Context memory for Video World Models. **`ECCV 2026`** [[Paper](https://arxiv.org/abs/2606.31734)] · 🧠`memory`
...
* Walking in the Implicit: Interactive World Exploration via Neural Scene Representation. **`ECCV 2026`** [[Paper](https://arxiv.org/abs/2606.30045)] · 🌍`systems`
...
* **`MemoBench`**, Benchmarking World Modeling in Dynamically Changing Environments. **`ECCV 2026`** [[Paper](https://arxiv.org/abs/2606.27537)] · 📊`benchmarks`
...
* **`LiveEdit`**, Towards Real-Time Diffusion-Based Streaming Video Editing. **`ECCV 2026`** [[Paper](https://arxiv.org/abs/2606.26740)] · 🕹️`control` ⚡`realtime`
...
* **`DSA`**, Dynamic Step Allocation for Fast Autoregressive Video Generation. **`CVPR 2026 (Findings)`** [[Paper](https://arxiv.org/abs/2606.04432)] · ⚡`realtime`
...
* **`DiT as Real-Time Rerenderer`**, Streaming Video Stylization with Autoregressive Diffusion Transformer. **`ECCV 2026`** [[Paper](https://arxiv.org/abs/2604.13509)] · ⚡`realtime`
...
* **`Salt`**, Self-Consistent Distribution Matching with Cache-Aware Training for Fast Video Generation. **`arXiv 2026.04`** [[Paper](https://arxiv.org/abs/2604.03118)] · 🧠`memory` ⚡`realtime`
* **`ActionParty`**, Multi-Subject Action Binding in Generative Video Games. **`ECCV 2026`** [[Paper](https://arxiv.org/abs/2604.02330)] · 🌍`systems`
...
* **`ShotStream`**, Streaming Multi-Shot Video Generation for Interactive Storytelling. **`ECCV 2026`** [[Paper](https://arxiv.org/abs/2603.25746)] · 🌍`systems` 🕹️`control` ⚡`realtime`
...
* Out of Sight, Out of Mind? Evaluating State Evolution in Video World Models. **`ECCV 2026`** [[Paper](https://arxiv.org/abs/2603.13215)] [[Website](https://glab-caltech.github.io/STEVOBench/)] · 🧠`memory` 📊`benchmarks`
* Anchor Forcing: Anchor Memory and Tri-Region RoPE for Interactive Streaming Video Diffusion. **`ECCV 2026`** [[Paper](https://arxiv.org/abs/2603.13405)] · ⚡`realtime` 🧠`memory`
* **`MemRoPE`**, Training-Free Infinite Video Generation via Evolving Memory Tokens. **`ECCV 2026`** [[Paper](https://arxiv.org/abs/2603.12513)] · 🧠`memory`
...
* **`OmniForcing`**, Unleashing Real-time Joint Audio-Visual Generation. **`ECCV 2026`** [[Paper](https://arxiv.org/abs/2603.11647)] · ⚡`realtime`
...
* **`Generated Reality`**, Human-centric World Simulation using Interactive Video Generation with Hand and Camera Control. **`CVPR 2026 (Findings)`** [[Paper](https://arxiv.org/abs/2602.18422)] · 🌍`systems` 🕹️`control`
* Factored Latent Action World Models. **`arXiv 2026.02`** [[Paper](https://arxiv.org/abs/2602.16229)] · 🕹️`control`
* **`AnchorWeave`**, World-Consistent Video Generation with Retrieved Local Spatial Memories. **`ECCV 2026`** [[Paper](https://arxiv.org/abs/2602.14941)] · 🧠`memory`
...
* Causality in Video Diffusers is Separable from Denoising. **`CVPR 2026`** [[Paper](https://arxiv.org/abs/2602.10095)] · ⚡`realtime`
...
* **`LoL`**, Longer than Longer, Scaling Video Generation to Hour. **`CVPR 2026`** [[Paper](https://arxiv.org/abs/2601.16914)] · ⚡`realtime`
...
* **`S2DiT`**, Sandwich Diffusion Transformer for Mobile Streaming Video Generation. **`CVPR 2026 (Findings)`** [[Paper](https://arxiv.org/abs/2601.12719)] · ⚡`realtime`
* Transition Matching Distillation for Fast Video Generation. **`CVPR 2026`** [[Paper](https://arxiv.org/abs/2601.09881)] · ⚡`realtime`
* Plenoptic Video Generation. **`CVPR 2026`** [[Paper](https://arxiv.org/abs/2601.05239)] · 🧠`memory`
...
* **`TinyHistory`**, Lightweight Video History Embeddings via Two-Stage Context Learning. **`ECCV 2026`** [[Paper](https://arxiv.org/abs/2512.23851)] · 🧠`memory`
...
* **`Yume-1.5`**, A Text-Controlled Interactive World Generation Model. **`CVPR 2026`** [[Paper](https://arxiv.org/abs/2512.22096)] [[Website](https://stdstu12.github.io/YUME-Project)] [[Code](https://github.com/stdstu12/YUME)] · 🌍`systems` 🕹️`control`
...
* **`CustomX`**, Unified Character, Action, and Scene Customization in Video World Models. **`ECCV 2026`** [[Paper](https://arxiv.org/abs/2512.17796)] · 🌍`systems` 🕹️`control`
...
* **`Spatia`**, Video Generation with Updatable Spatial Memory. **`CVPR 2026`** [[Paper](https://arxiv.org/abs/2512.15716)] · 🌍`systems` 🕹️`control` 🧠`memory`
* End-to-End Training for Autoregressive Video Diffusion via Self-Resampling. **`ECCV 2026`** [[Paper](https://arxiv.org/abs/2512.15702)] · 🧠`memory`
...
* Endless World: Real-Time 3D-Aware Long Video Generation. **`CVPR 2026`** [[Paper](https://arxiv.org/abs/2512.12430)] · ⚡`realtime`
* **`BAgger`**, Backwards Aggregation for Mitigating Drift in Autoregressive Video Diffusion Models. **`CVPR 2026`** [[Paper](https://arxiv.org/abs/2512.12080)] · 🧠`memory`
...
* **`TV2TV`**, A Unified Framework for Interleaved Language and Video Generation. **`CVPR 2026`** [[Paper](https://arxiv.org/abs/2512.05103)] · 🕹️`control`
...
* Reward Forcing: Efficient Streaming Video Generation with Rewarded Distribution Matching Distillation. **`CVPR 2026`** [[Paper](https://arxiv.org/abs/2512.04678)] · ⚡`realtime`
...
* **`WorldPack`**, Dynamic Frame Compression for Long-context Video World Modeling. **`arXiv 2025.12`** [[Paper](https://arxiv.org/abs/2512.02473)] · 🌍`systems` 🧠`memory`
...
* **`Infinity-RoPE`**, Action-Controllable Infinite Video Generation Emerges From Autoregressive Self-Rollout. **`CVPR 2026`** [[Paper](https://arxiv.org/abs/2511.20649)] · 🕹️`control`
* Block Cascading: Training Free Acceleration of Block-Causal Video Models. **`CVPR 2026 (Findings)`** [[Paper](https://arxiv.org/abs/2511.20426)] · ⚡`realtime`
...
* Recurrent Autoregressive Diffusion: Global Memory Meets Local Attention. **`ECCV 2026`** [[Paper](https://arxiv.org/abs/2511.12940)] · 🧠`memory`
...
* **`TGT`**, Text-Grounded Trajectories for Locally Controlled Video Generation. **`CVPR 2026`** [[Paper](https://arxiv.org/abs/2510.15104)] · 🕹️`control`
...
* **`StreamDiT`**, Real-Time Streaming Text-to-Video Generation. **`CVPR 2026`** [[Paper](https://arxiv.org/abs/2507.03745)] · ⚡`realtime`
...
* Joint Alignment and Distillation for Video Generation via Sample-Guided Distribution Matching. [[Paper](https://arxiv.org/abs/2609.04283)] · ⚡`realtime`
* **`OctWorld`**, Long-Range World-Consistent Video Generation with Octree-Based 3D Mapping. [[Paper](https://arxiv.org/abs/2609.03919)] · 🌍`systems` 🧠`memory`
...
* Walking in the Implicit: Interactive World Exploration via Neural Scene Representation. [[Paper](https://arxiv.org/abs/2606.30045)] · 🌍`systems`
...
* **`PackForcing`**, Short Video Training Suffices for Long Video Sampling and Long Context Inference. [[Paper](https://arxiv.org/abs/2603.25730)] · 🧠`memory`
* **`DCARL`**, A Divide-and-Conquer Framework for Autoregressive Long-Trajectory Video Generation. [[Paper](https://arxiv.org/abs/2603.24835)] · 🕹️`control`
* **`WildWorld`**, A Large-Scale Dataset for Dynamic World Modeling with Actions and Explicit State toward Generative ARPG. [[Paper](https://arxiv.org/abs/2603.23497)] [[Website](https://alaya-studio.github.io/wildworld-project/)] [[Code](https://github.com/AlayaLab/WildWorld)] · 🗂️`datasets`
* **`WorldCache`**, Content-Aware Caching for Accelerated Video World Models. [[Paper](https://arxiv.org/abs/2603.22286)] [[Website](https://umair1221.github.io/World-Cache/)] · ⚡`realtime`
* Out of Sight, Out of Mind? Evaluating State Evolution in Video World Models. [[Paper](https://arxiv.org/abs/2603.13215)] [[Website](https://glab-caltech.github.io/STEVOBench/)] · 🧠`memory` 📊`benchmarks`
...
* **`MoGAN`**, Improving Motion Quality in Video Diffusion via Few-Step Motion Adversarial Post-Training. [[Paper](https://eccv.ecva.net/virtual/2026/poster/3966)] · ⚡`realtime`
* When Distillation Breaks Motion Control: Restoring Generative Trajectories for Fast Video Generators. [[Paper](https://eccv.ecva.net/virtual/2026/poster/3640)] · 🕹️`control` ⚡`realtime`
...
* **`KineBench`**, Benchmarking Embodied World Models via IDM-Free Kinematic Grounding. [[Paper](https://eccv.ecva.net/virtual/2026/poster/5861)] [[Code](https://github.com/minecraft-zzz/KineBench)] · 📊`benchmarks`
* Infinite-Homography as Robust Conditioning for Camera-Controlled Video Generation. [[Paper](https://eccv.ecva.net/virtual/2026/poster/4255)] · 🕹️`control` 🧠`memory`
* **`IC-World`**, In-Context Generation for Shared World Modeling. [[Paper](https://eccv.ecva.net/virtual/2026/poster/4031)] [[Code](https://github.com/wufan-cse/IC-World)] · 🧠`memory`
* **`RotateAttention`**, RotateAttention : RoPE-Aware Rotation and Range Rectification for INT4 Quantized Attention in Video Generation. [[Paper](https://eccv.ecva.net/virtual/2026/poster/5842)] · ⚡`realtime`
* **`AR-CoPO`**, Align Autoregressive Video Generation with Contrastive Policy Optimization. [[Paper](https://eccv.ecva.net/virtual/2026/poster/3579)] · ⚡`realtime`
* Reward Lightning: Fast Video Generation via Homologous Preference Distillation. [[Paper](https://eccv.ecva.net/virtual/2026/poster/4259)] [[Code](https://github.com/reward-lightning/reward-lightning.github.io)] · ⚡`realtime`
...
* **`FlashDecoder`**, Real-Time Latent-to-Pixel Streaming Decoder with Transformers. [[Paper](https://arxiv.org/abs/2607.14898)] · ⚡`realtime`
* Causality in Video Diffusers is Separable from Denoising. [[Paper](https://arxiv.org/abs/2602.10095)] · ⚡`realtime`
* **`LoL`**, Longer than Longer, Scaling Video Generation to Hour. [[Paper](https://arxiv.org/abs/2601.16914)] · ⚡`realtime`
* Transition Matching Distillation for Fast Video Generation. [[Paper](https://arxiv.org/abs/2601.09881)] · ⚡`realtime`
* Plenoptic Video Generation. [[Paper](https://arxiv.org/abs/2601.05239)] · 🧠`memory`
* **`Yume-1.5`**, A Text-Controlled Interactive World Generation Model. [[Paper](https://arxiv.org/abs/2512.22096)] [[Website](https://stdstu12.github.io/YUME-Project)] [[Code](https://github.com/stdstu12/YUME)] · 🌍`systems` 🕹️`control`
* **`Spatia`**, Video Generation with Updatable Spatial Memory. [[Paper](https://arxiv.org/abs/2512.15716)] · 🌍`systems` 🕹️`control` 🧠`memory`
* Endless World: Real-Time 3D-Aware Long Video Generation. [[Paper](https://arxiv.org/abs/2512.12430)] · ⚡`realtime`
* **`BAgger`**, Backwards Aggregation for Mitigating Drift in Autoregressive Video Diffusion Models. [[Paper](https://arxiv.org/abs/2512.12080)] · 🧠`memory`
* **`TV2TV`**, A Unified Framework for Interleaved Language and Video Generation. [[Paper](https://arxiv.org/abs/2512.05103)] · 🕹️`control`
* Reward Forcing: Efficient Streaming Video Generation with Rewarded Distribution Matching Distillation. [[Paper](https://arxiv.org/abs/2512.04678)] · ⚡`realtime`
* **`Infinity-RoPE`**, Action-Controllable Infinite Video Generation Emerges From Autoregressive Self-Rollout. [[Paper](https://arxiv.org/abs/2511.20649)] · 🕹️`control`
* **`TGT`**, Text-Grounded Trajectories for Locally Controlled Video Generation. [[Paper](https://arxiv.org/abs/2510.15104)] · 🕹️`control`
* **`StreamDiT`**, Real-Time Streaming Text-to-Video Generation. [[Paper](https://arxiv.org/abs/2507.03745)] · ⚡`realtime`
* **`RAPID`**, Reusing Attention Sparsity with Inter-step Adaptation for Efficient Video Diffusion. [[Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Lin_RAPID_Reusing_Attention_Sparsity_with_Inter-step_Adaptation_for_Efficient_Video_CVPR_2026_paper.html)] [[Code](https://github.com/aladerran/RAPID)] · ⚡`realtime`
* **`DisCa`**, Accelerating Video Diffusion Transformers with Distillation-Compatible Learnable Feature Caching. [[Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zou_DisCa_Accelerating_Video_Diffusion_Transformers_with_Distillation-Compatible_Learnable_Feature_Caching_CVPR_2026_paper.html)] [[Code](https://github.com/Shenyi-Z/DisCa-page)] · ⚡`realtime`
* **`DeltaQuant`**, 4-bit Video Diffusion Models with Spatiotemporal Delta Smoothing. [[Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Li_DeltaQuant_4-bit_Video_Diffusion_Models_with_Spatiotemporal_Delta_Smoothing_CVPR_2026_paper.html)] · ⚡`realtime`
* **`ReHyAt`**, Recurrent Hybrid Attention for Video Diffusion Transformers. [[Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Ghafoorian_ReHyAt_Recurrent_Hybrid_Attention_for_Video_Diffusion_Transformers_CVPR_2026_paper.html)] · ⚡`realtime` 🧠`memory`
* Dual-Granularity Memory for Efficient Video Generation. [[Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Wang_Dual-Granularity_Memory_for_Efficient_Video_Generation_CVPR_2026_paper.html)] · ⚡`realtime` 🧠`memory`
* **`SwitchCraft`**, Training-Free Multi-Event Video Generation with Attention Controls. [[Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Xu_SwitchCraft_Training-Free_Multi-Event_Video_Generation_with_Attention_Controls_CVPR_2026_paper.html)] [[Code](https://github.com/Westlake-AGI-Lab/SwitchCraft)] · 🕹️`control`
* Accelerating Autoregressive Video Diffusion via History-Guided Cache and Residual Correction. [[Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Nan_Accelerating_Autoregressive_Video_Diffusion_via_History-Guided_Cache_and_Residual_Correction_CVPR_2026_paper.html)] · ⚡`realtime`
* Unified Camera Positional Encoding for Controlled Video Generation. [[Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zhang_Unified_Camera_Positional_Encoding_for_Controlled_Video_Generation_CVPR_2026_paper.html)] · 🕹️`control`
* **`VMonarch`**, Efficient Video Diffusion Transformers with Structured Attention. [[Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Liang_VMonarch_Efficient_Video_Diffusion_Transformers_with_Structured_Attention_CVPR_2026_paper.html)] · ⚡`realtime`
* **`FastLightGen`**, Fast and Light Video Generation with Fewer Steps and Parameters. [[Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Shao_FastLightGen_Fast_and_Light_Video_Generation_with_Fewer_Steps_and_CVPR_2026_paper.html)] · ⚡`realtime`
* Content-Aware Dynamic Patchification for Efficient Video Diffusion. [[Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Li_Content-Aware_Dynamic_Patchification_for_Efficient_Video_Diffusion_CVPR_2026_paper.html)] · ⚡`realtime`
* **`LinVideo`**, A Post-Training Framework towards O(n) Attention in Efficient Video Generation. [[Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Huang_LinVideo_A_Post-Training_Framework_towards_On_Attention_in_Efficient_Video_CVPR_2026_paper.html)] · ⚡`realtime`
* Free-Lunch Long Video Generation via Layer-Adaptive O.O.D Correction. [[Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Tian_Free-Lunch_Long_Video_Generation_via_Layer-Adaptive_O.O.D_Correction_CVPR_2026_paper.html)] [[Code](https://github.com/Westlake-AGI-Lab/FreeLOC)] · 🧠`memory`
* **`D2Cache`**, Second-Order Delta Caching for Higher Video Diffusion Acceleration. [[Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Liu_D2Cache_Second-Order_Delta_Caching_for_Higher_Video_Diffusion_Acceleration_CVPR_2026_paper.html)] [[Code](https://github.com/VG-Huai/D2Cache)] · ⚡`realtime`
* **`AdaCluster`**, Adaptive Query-Key Clustering for Sparse Attention in Video Generation. [[Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Tan_AdaCluster_Adaptive_Query-Key_Clustering_for_Sparse_Attention_in_Video_Generation_CVPR_2026_paper.html)] · ⚡`realtime`
* **`VerseCrafter`**, Dynamic Realistic Video World Model with 4D Geometric Control. [[Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Zheng_VerseCrafter_Dynamic_Realistic_Video_World_Model_with_4D_Geometric_Control_CVPR_2026_paper.html)] [[Code](https://github.com/TencentARC/VerseCrafter)] · 🕹️`control` 🧠`memory`
* Attention Surgery: An Efficient Recipe to Linearize Your Video Diffusion Transformer. [[Paper](https://openaccess.thecvf.com/content/CVPR2026/html/Ghafoorian_Attention_Surgery_An_Efficient_Recipe_to_Linearize_Your_Video_Diffusion_CVPR_2026_paper.html)] · ⚡`realtime`

#### CVPR 2026 (Findings)

* **`DSA`**, Dynamic Step Allocation for Fast Autoregressive Video Generation. [[Paper](https://arxiv.org/abs/2606.04432)] · ⚡`realtime`
* **`Generated Reality`**, Human-centric World Simulation using Interactive Video Generation with Hand and Camera Control. [[Paper](https://arxiv.org/abs/2602.18422)] · 🌍`systems` 🕹️`control`
* **`S2DiT`**, Sandwich Diffusion Transformer for Mobile Streaming Video Generation. [[Paper](https://arxiv.org/abs/2601.12719)] · ⚡`realtime`
* Block Cascading: Training Free Acceleration of Block-Causal Video Models. [[Paper](https://arxiv.org/abs/2511.20426)] · ⚡`realtime`
* **`USV`**, Unified Sparsification for Accelerating Video Diffusion Models. [[Paper](https://openaccess.thecvf.com/content/CVPR2026F/html/Wu_USV_Unified_Sparsification_for_Accelerating_Video_Diffusion_Models_CVPRF_2026_paper.html)] · ⚡`realtime`
* **`HiStream`**, Efficient High-Resolution Video Generation via Redundancy Eliminated Streaming. [[Paper](https://openaccess.thecvf.com/content/CVPR2026F/html/Qiu_HiStream_Efficient_High-Resolution_Video_Generation_via_Redundancy_Eliminated_Streaming_CVPRF_2026_paper.html)] [[Code](https://github.com/Jon-drugstore/HiStream)] · ⚡`realtime`
* Fast Autoregressive Video Generation with Diagonal Decoding. [[Paper](https://openaccess.thecvf.com/content/CVPR2026F/html/Ye_Fast_Autoregressive_Video_Generation_with_Diagonal_Decoding_CVPRF_2026_paper.html)] · ⚡`realtime`

#### ICML 2026

* **`DiLA`**, Disentangled Latent Action World Models. [[Paper](https://arxiv.org/abs/2605.15725)] [[Website](http://disentangled-latent-action-world-models.github.io)] · 🕹️`control`
* **`iWorld-Bench`**, A Benchmark for Interactive World Models with a Unified Action Generation Framework. [[Paper](https://arxiv.org/abs/2605.03941)] · 📊`benchmarks`

#### Alibaba 2026

* **`Happy Oyster`**, Happy Oyster (Kuaile Shenghao): Real-Time Interactive Open-World Model. [[Blog](https://happyoyster.cn/)] · 📰`reports` ⚡`realtime`

#### ICLR 2026

* Composition of Memory Experts for Diffusion World Models. [[Paper](https://arxiv.org/abs/2605.18813)] · 🧠`memory`

#### PixVerse 2026

* **`PixVerse R1`**, A Real-Time World Model That Redefines AI Video Generation. [[Blog](https://pixverse.ai/en/blog/pixverse-launches-r1-real-time-world-model)] · 📰`reports` ⚡`realtime`

#### World Modeling Workshop 2026

* **`On Memory`**, A comparison of memory mechanisms in world models. [[Paper](https://arxiv.org/abs/2512.06983)] · 🧠`memory`

#### DeepMind 2025

* **`Genie 3`**, A new frontier for world models. [[Blog](https://deepmind.google/blog/genie-3-a-new-frontier-for-world-models/)] · 📰`reports`

#### Decart & Etched 2024

* **`Oasis`**, A Universe in a Transformer. [[Blog](https://oasis-model.github.io/)] · 📰`reports`

#### DeepMind 2024

* **`Genie 2`**, A large-scale foundation world model. [[Blog](https://deepmind.google/discover/blog/genie-2-a-large-scale-foundation-world-model/)] · 📰`reports`

#### OpenAI 2024

* **`Sora`**, Video generation models as world simulators. [[Blog](https://openai.com/index/video-generation-models-as-world-simulators/)] · 📰`reports`

#### NIPS 2018 Oral

* World Models. [[Paper](https://arxiv.org/abs/1803.10122)] [[Website](https://worldmodels.github.io/)] · 🌱`foundations`

#### DeepMind

* **`Genie`**, Generative Interactive Environments. [[Paper](https://arxiv.org/abs/2402.15391)] [[Blog](https://sites.google.com/view/genie-2024/home)] · 🌱`foundations`

#### World Labs

* **`Atlas`**, A World Model for Spatial Intelligence. [[Blog](https://www.worldlabs.ai/blog/atlas)] · 📰`reports`
<!-- END:VENUES -->
...
| [Visko Orbis 1.0](https://arxiv.org/abs/2607.26694) | 2026-07 | causal diffusion | language | — | compressive | no |
